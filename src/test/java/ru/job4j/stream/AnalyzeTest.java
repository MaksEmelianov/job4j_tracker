...
public class AnalyzeTest {
                ...
                Stream.of(
                        ...
                        new Pupil("Sidorov",
                                List.of(
                                        new Subject("Math", 60),
                                        new Subject("Lang", 50),
                                        new Subject("Philosophy", 40)
                                ))
                )
        );
        assertThat(average).isCloseTo(70, offset(0.01D));
    }
    ...
    void whenListOfPupilAverage() {
        ...
        assertThat(average).hasSameElementsAs(
                List.of(
    ...
    void whenBestSubject() {
        ...
        assertThat(best).isEqualTo(new Tuple("Math", 300D));
    }
}
